...
file=ROOT.TFile("raw_FF_et.root","r")
categories=["et_0jet_qcd_iso","et_0jet_qcd_anti","et_1jet_qcd_anti","et_1jet_qcd_iso","et_0jet_w_anti","et_0jet_w_iso","et_1jet_w_anti","et_1jet_w_iso","et_0jet_tt_iso","et_0jet_tt_anti","et_0SSloose_qcd_anti","et_0SSloose_qcd_iso","et_1SSloose_qcd_anti","et_1SSloose_qcd_iso"] 
ncat=14

if options.step=="mvisclosure":
  categories=["et_0jet_qcd_iso","et_0jet_qcd_anti","et_0jet_w_anti","et_0jet_w_iso","et_0jet_tt_iso","et_0jet_tt_anti"]
  ncat=6
  file=ROOT.TFile("mvisclosure_et.root","r")

if options.step=="osss":
  categories=["et_0jet_qcd_iso","et_0jet_qcd_anti"]
  ncat=2
  file=ROOT.TFile("OSSScorr_et.root","r")
...
for i in range (0,ncat):
   ...
   if options.step=="mvisclosure" or options.step=="osss":
