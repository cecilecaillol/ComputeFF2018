...
rm -f $exefilename
g++ $1 -o $exefilename `root-config --cflags --glibs` -lRooFit -lRooFitCore /afs/cern.ch/work/a/aloelige/private/ComputeFF/CMSSW_9_4_0/lib/slc7_amd64_gcc630/libTauAnalysisToolsTauTriggerSFs.so
echo ""
