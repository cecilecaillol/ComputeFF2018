...
int main(int argc, char** argv) {
   ...
   float bins_lpt0[] = {25,28,33,38,43,48,53,58,63,68,73,78,83,88,93,98,110,120,130,140,150};
   int  binnum_lpt0 = sizeof(bins_lpt0)/sizeof(Float_t) - 1;
   float bins_cat0[] = {0,1,2,3,4,5,6};
   int  binnum_cat0 = sizeof(bins_cat0)/sizeof(Float_t) - 1;
   ...
   TH1F* h0LT_qcd_cat_iso = new TH1F ("h0LT_qcd_cat_iso","h0LT_qcd_cat_iso",binnum_cat0,bins_cat0); h0LT_qcd_cat_iso->Sumw2();
   TH1F* h0LT_qcd_cat_anti = new TH1F ("h0LT_qcd_cat_anti","h0LT_qcd_cat_anti",binnum_cat0,bins_cat0); h0LT_qcd_cat_anti->Sumw2();
   ...
   TH1F* h0LT_w_cat_iso = new TH1F ("h0LT_w_cat_iso","h0LT_w_cat_iso",binnum_cat0,bins_cat0); h0LT_w_cat_iso->Sumw2();
   TH1F* h0LT_w_cat_anti = new TH1F ("h0LT_w_cat_anti","h0LT_w_cat_anti",binnum_cat0,bins_cat0); h0LT_w_cat_anti->Sumw2();
   ...
   TH1F* h0LT_tt_cat_iso = new TH1F ("h0LT_tt_cat_iso","h0LT_tt_cat_iso",binnum_cat0,bins_cat0); h0LT_tt_cat_iso->Sumw2();
   TH1F* h0LT_tt_cat_anti = new TH1F ("h0LT_tt_cat_anti","h0LT_tt_cat_anti",binnum_cat0,bins_cat0); h0LT_tt_cat_anti->Sumw2();
   ...
   TH1F* h0J_qcd_cat_iso = new TH1F ("h0J_qcd_cat_iso","h0J_qcd_cat_iso",binnum_cat0,bins_cat0); h0J_qcd_cat_iso->Sumw2();
   TH1F* h0J_qcd_cat_anti = new TH1F ("h0J_qcd_cat_anti","h0J_qcd_cat_anti",binnum_cat0,bins_cat0); h0J_qcd_cat_anti->Sumw2();
   ...
   TH1F* h0J_w_cat_iso = new TH1F ("h0J_w_cat_iso","h0J_w_cat_iso",binnum_cat0,bins_cat0); h0J_w_cat_iso->Sumw2();
   TH1F* h0J_w_cat_anti = new TH1F ("h0J_w_cat_anti","h0J_w_cat_anti",binnum_cat0,bins_cat0); h0J_w_cat_anti->Sumw2();
   ...
   TH1F* h0J_tt_cat_iso = new TH1F ("h0J_tt_cat_iso","h0J_tt_cat_iso",binnum_cat0,bins_cat0); h0J_tt_cat_iso->Sumw2();
   TH1F* h0J_tt_cat_anti = new TH1F ("h0J_tt_cat_anti","h0J_tt_cat_anti",binnum_cat0,bins_cat0); h0J_tt_cat_anti->Sumw2();
   ...
   TF1* lptclosure_w=(TF1*) fmvisclosure.Get("closure_lpt_et_0jet_w");
   TF1* lptclosure_qcd=(TF1*) fmvisclosure.Get("closure_lpt_et_0jet_qcd");
   TF1* lptclosure_tt=(TF1*) fmvisclosure.Get("closure_lpt_et_ttmc");
   TF1* lptclosure_w_xtrg=(TF1*) fmvisclosure.Get("closure_lpt_xtrg_et_0jet_w");
   TF1* lptclosure_qcd_xtrg=(TF1*) fmvisclosure.Get("closure_lpt_xtrg_et_0jet_qcd");
   TF1* lptclosure_tt_xtrg=(TF1*) fmvisclosure.Get("closure_lpt_xtrg_et_ttmc");
   ...
   for (Int_t i = 0; i < nentries_wtn; i++) {
	...
	//************************* Fill histograms **********************
	  ...
	  int mycat=-1;
	  if (njets==0 && myele.DeltaR(mytau)>3) mycat=0;
          if (njets==0 && myele.DeltaR(mytau)<=3) mycat=1;
          if (njets==1) mycat=2;
          if (njets>1 && mjj<350) mycat=3;
          if (njets>1 && mjj>350 && (myele+mytau+mymet).Pt()<200) mycat=4;
          if (njets>1 && mjj>350 && (myele+mytau+mymet).Pt()>200) mycat=5;
	  ...
	  if (njets==1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_1jet);
	     ...
	     if ((year=="2016" and myele.Pt()>26) or (year=="2017" and myele.Pt()>28) or (year=="2018" and myele.Pt()>33)){
	        ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_0jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd);
	        if (njets==1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_1jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd);
	        if (njets>1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_2jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd);
	        ff_w=get_raw_FF(mytau.Pt(),ff_w_0jet)*get_mvis_closure(myele.Pt(),lptclosure_w);
	        if (njets==1) ff_w=get_raw_FF(mytau.Pt(),ff_w_1jet)*get_mvis_closure(myele.Pt(),lptclosure_w);
	        if (njets>1) ff_w=get_raw_FF(mytau.Pt(),ff_w_2jet)*get_mvis_closure(myele.Pt(),lptclosure_w);
	        ff_tt=get_raw_FF(mytau.Pt(),ff_tt_0jet)*get_mvis_closure(myele.Pt(),lptclosure_tt);
	     }
	     else{
                ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_0jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd_xtrg);
                if (njets==1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_1jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd_xtrg);
                if (njets>1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_2jet)*get_mvis_closure(myele.Pt(),lptclosure_qcd_xtrg);
                ff_w=get_raw_FF(mytau.Pt(),ff_w_0jet)*get_mvis_closure(myele.Pt(),lptclosure_w_xtrg);
                if (njets==1) ff_w=get_raw_FF(mytau.Pt(),ff_w_1jet)*get_mvis_closure(myele.Pt(),lptclosure_w_xtrg);
                if (njets>1) ff_w=get_raw_FF(mytau.Pt(),ff_w_2jet)*get_mvis_closure(myele.Pt(),lptclosure_w_xtrg);
                ff_tt=get_raw_FF(mytau.Pt(),ff_tt_0jet)*get_mvis_closure(myele.Pt(),lptclosure_tt_xtrg);
             }
	  }
	  ...
	  if (name=="WMC"){
	     ...
	     if (apply_corrections=="yes"){
	       if ((year=="2016" and myele.Pt()>26) or (year=="2017" and myele.Pt()>28) or (year=="2018" and myele.Pt()>33)){
		 ff_tt=get_raw_FF(mytau.Pt(),ff_ttmc_0jet)*get_mvis_closure(myele.Pt(),lptclosure_tt);
	       }
	       else{
		 ff_tt=get_raw_FF(mytau.Pt(),ff_ttmc_0jet)*get_mvis_closure(myele.Pt(),lptclosure_tt_xtrg);
	       }
	     }
          }	  
	     ...
	     if (isL or isT){
	       ...
	       // QCD
               if (signalRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets==0) h0LT_qcd_dr_iso->Fill(myele.DeltaR(mytau),aweight*weight2);
                  h0LT_qcd_met_iso->Fill(mymet.Pt(),aweight*weight2);
                  h0LT_qcd_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0LT_qcd_cat_iso->Fill(mycat,aweight*weight2);
                  ...
                  if (njets==0 && myele.DeltaR(mytau)>3) h0LT_qcd_cat0jetlow_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0LT_qcd_cat0jethigh_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
               ...
               if (antiisoRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets==0) h0LT_qcd_dr_anti->Fill(myele.DeltaR(mytau),aweight*weight2*ff_qcd);
                  h0LT_qcd_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_qcd);
                  h0LT_qcd_cat_anti->Fill(mycat,aweight*weight2*ff_qcd);
                  ...
                  if (njets==0 && myele.DeltaR(mytau)>3) h0LT_qcd_cat0jetlow_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_qcd);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0LT_qcd_cat0jethigh_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_qcd);
		  ...
		  if (njets==0) h0LT_w_mvis_iso->Fill(myvar,aweight*weight2);
                  ...
                  if (njets==0) h0LT_w_dr_iso->Fill(myele.DeltaR(mytau),aweight*weight2);
                  h0LT_w_met_iso->Fill(mymet.Pt(),aweight*weight2);
                  h0LT_w_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0LT_w_cat_iso->Fill(mycat,aweight*weight2);
                  if (njets>0) h0LT_w_pth_iso->Fill((myele+mymet+mytau).Pt(),aweight*weight2);
                  if (njets>1) h0LT_w_mjj_iso->Fill(mjj,aweight*weight2);
		  if (njets==0 && myele.DeltaR(mytau)>3) h0LT_w_cat0jetlow_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
		  if (njets==0 && myele.DeltaR(mytau)<3) h0LT_w_cat0jethigh_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
		  ...
		  if (njets==0) h0LT_w_mvis_anti->Fill(myvar,aweight*weight2*ff_w);
                  ...
                  if (njets==0) h0LT_w_dr_anti->Fill(myele.DeltaR(mytau),aweight*weight2*ff_w);
                  h0LT_w_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_w);
                  h0LT_w_cat_anti->Fill(mycat,aweight*weight2*ff_w);
                  ...
                  if (njets==0 && myele.DeltaR(mytau)>3) h0LT_w_cat0jetlow_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_w);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0LT_w_cat0jethigh_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_w);
	       ...
	       // TT
               if (signalRegion && iso_1<0.15 && nbtag>0 && mt<50 && q_1*q_2<0){
                  ...
                  h0LT_tt_pth_iso->Fill((myele+mytau+mymet).Pt(),aweight*weight2);
                  h0LT_tt_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0LT_tt_cat_iso->Fill(mycat,aweight*weight2);
	       }
               if (antiisoRegion && iso_1<0.15 && nbtag>0 && mt<50 && q_1*q_2<0){
                  ...
                  h0LT_tt_pth_anti->Fill((myele+mytau+mymet).Pt(),aweight*weight2*ff_tt);
                  h0LT_tt_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_tt);
                  h0LT_tt_cat_anti->Fill(mycat,aweight*weight2*ff_tt);
	       }
               ...
               if (signalRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets==0) h0J_qcd_dr_iso->Fill(myele.DeltaR(mytau),aweight*weight2);
                  h0J_qcd_met_iso->Fill(mymet.Pt(),aweight*weight2);
                  h0J_qcd_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0J_qcd_cat_iso->Fill(mycat,aweight*weight2);
                  if (njets>0) h0J_qcd_pth_iso->Fill((myele+mymet+mytau).Pt(),aweight*weight2);
                  if (njets>1) h0J_qcd_mjj_iso->Fill(mjj,aweight*weight2);
                  if (njets==0 && myele.DeltaR(mytau)>3) h0J_qcd_cat0jetlow_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0J_qcd_cat0jethigh_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
               ...
               if (antiisoRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets==0) h0J_qcd_dr_anti->Fill(myele.DeltaR(mytau),aweight*weight2*ff_qcd);
                  h0J_qcd_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_qcd);
                  h0J_qcd_cat_anti->Fill(mycat,aweight*weight2*ff_qcd);
                  ...
                  if (njets==0 && myele.DeltaR(mytau)>3) h0J_qcd_cat0jetlow_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_qcd);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0J_qcd_cat0jethigh_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_qcd);
		  ...
		  if (njets==0) h0J_w_mvis_iso->Fill(myvar,aweight*weight2);
                  ...
                  if (njets==0) h0J_w_dr_iso->Fill(myele.DeltaR(mytau),aweight*weight2);
                  h0J_w_met_iso->Fill(mymet.Pt(),aweight*weight2);
                  h0J_w_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0J_w_cat_iso->Fill(mycat,aweight*weight2);
                  if (njets>0) h0J_w_pth_iso->Fill((myele+mymet+mytau).Pt(),aweight*weight2);
                  if (njets>1) h0J_w_mjj_iso->Fill(mjj,aweight*weight2);
		  if (njets==0 && myele.DeltaR(mytau)>3) h0J_w_cat0jetlow_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
		  if (njets==0 && myele.DeltaR(mytau)<3) h0J_w_cat0jethigh_iso->Fill(mytau.Pt(),m_sv,aweight*weight2);
		  ...
		  if (njets==0) h0J_w_mvis_anti->Fill(myvar,aweight*weight2*ff_w);
                  ...
                  h0J_w_dr_anti->Fill(myele.DeltaR(mytau),aweight*weight2*ff_w);
                  h0J_w_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_w);
                  h0J_w_cat_anti->Fill(mycat,aweight*weight2*ff_w);
                  ...
                  if (njets==0 && myele.DeltaR(mytau)>3) h0J_w_cat0jetlow_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_w);
                  if (njets==0 && myele.DeltaR(mytau)<3) h0J_w_cat0jethigh_anti->Fill(mytau.Pt(),m_sv,aweight*weight2*ff_w);
	       ...
	       // TT
               if (signalRegion && iso_1<0.15 && nbtag>0 && mt<50 && q_1*q_2<0){
                  ...
                  h0J_tt_pth_iso->Fill((myele+mytau+mymet).Pt(),aweight*weight2);
                  h0J_tt_lpt_iso->Fill(myele.Pt(),aweight*weight2);
                  h0J_tt_cat_iso->Fill(mycat,aweight*weight2);

	       }
               if (antiisoRegion && iso_1<0.15 && nbtag>0 && mt<50 && q_1*q_2<0){
                  h0J_tt_anti->Fill(myvar,aweight*weight2*ff_tt);
                  if (njets>1) h0J_tt_mjj_anti->Fill(mjj,aweight*weight2*ff_tt);
                  h0J_tt_pth_anti->Fill((myele+mytau+mymet).Pt(),aweight*weight2*ff_tt);
                  h0J_tt_lpt_anti->Fill(myele.Pt(),aweight*weight2*ff_tt);
                  h0J_tt_cat_anti->Fill(mycat,aweight*weight2*ff_tt);
	       }
            }
    ...
    TDirectory *d0_qcd_dr_iso =fout->mkdir("et_0jet_qcd_dr_iso");
    d0_qcd_dr_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_dr_anti =fout->mkdir("et_0jet_qcd_dr_anti");
    d0_qcd_dr_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_met_iso =fout->mkdir("et_0jet_qcd_met_iso");
    d0_qcd_met_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_met_anti =fout->mkdir("et_0jet_qcd_met_anti");
    d0_qcd_met_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_lpt_iso =fout->mkdir("et_0jet_qcd_lpt_iso");
    d0_qcd_lpt_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_lpt_anti =fout->mkdir("et_0jet_qcd_lpt_anti");
    d0_qcd_lpt_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_cat_iso =fout->mkdir("et_0jet_qcd_cat_iso");
    d0_qcd_cat_iso->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_qcd_cat_iso->SetName(name.c_str());
      h0LT_qcd_cat_iso->Add(h0J_qcd_cat_iso);
      h0LT_qcd_cat_iso->Write();
    }
    else{
      h0LT_qcd_cat_iso->SetName(name.c_str()+postfixLT);
      h0LT_qcd_cat_iso->Write();
      h0J_qcd_cat_iso->SetName(name.c_str()+postfixJ);
      h0J_qcd_cat_iso->Write();
    }
    TDirectory *d0_qcd_cat_anti =fout->mkdir("et_0jet_qcd_cat_anti");
    d0_qcd_cat_anti->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_qcd_cat_anti->SetName(name.c_str());
      h0LT_qcd_cat_anti->Add(h0J_qcd_cat_anti);
      h0LT_qcd_cat_anti->Write();
    }
    else{
      h0LT_qcd_cat_anti->SetName(name.c_str()+postfixLT);
      h0LT_qcd_cat_anti->Write();
      h0J_qcd_cat_anti->SetName(name.c_str()+postfixJ);
      h0J_qcd_cat_anti->Write();
    }
    ...
    TDirectory *d0_w_dr_iso =fout->mkdir("et_0jet_w_dr_iso");
    d0_w_dr_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_dr_anti =fout->mkdir("et_0jet_w_dr_anti");
    d0_w_dr_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_met_iso =fout->mkdir("et_0jet_w_met_iso");
    d0_w_met_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_met_anti =fout->mkdir("et_0jet_w_met_anti");
    d0_w_met_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_lpt_iso =fout->mkdir("et_0jet_w_lpt_iso");
    d0_w_lpt_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_lpt_anti =fout->mkdir("et_0jet_w_lpt_anti");
    d0_w_lpt_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_cat_iso =fout->mkdir("et_0jet_w_cat_iso");
    d0_w_cat_iso->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_w_cat_iso->SetName(name.c_str());
      h0LT_w_cat_iso->Add(h0J_w_cat_iso);
      h0LT_w_cat_iso->Write();
    }
    else{
      h0LT_w_cat_iso->SetName(name.c_str()+postfixLT);
      h0LT_w_cat_iso->Write();
      h0J_w_cat_iso->SetName(name.c_str()+postfixJ);
      h0J_w_cat_iso->Write();
    }
    TDirectory *d0_w_cat_anti =fout->mkdir("et_0jet_w_cat_anti");
    d0_w_cat_anti->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_w_cat_anti->SetName(name.c_str());
      h0LT_w_cat_anti->Add(h0J_w_cat_anti);
      h0LT_w_cat_anti->Write();
    }
    else{
      h0LT_w_cat_anti->SetName(name.c_str()+postfixLT);
      h0LT_w_cat_anti->Write();
      h0J_w_cat_anti->SetName(name.c_str()+postfixJ);
      h0J_w_cat_anti->Write();
    }
    ...
    TDirectory *d0_tt_pth_iso =fout->mkdir("et_0jet_tt_pth_iso");
    d0_tt_pth_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_tt_pth_anti =fout->mkdir("et_0jet_tt_pth_anti");
    d0_tt_pth_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_tt_lpt_iso =fout->mkdir("et_0jet_tt_lpt_iso");
    d0_tt_lpt_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_tt_lpt_anti =fout->mkdir("et_0jet_tt_lpt_anti");
    d0_tt_lpt_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_tt_cat_iso =fout->mkdir("et_0jet_tt_cat_iso");
    d0_tt_cat_iso->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_tt_cat_iso->SetName(name.c_str());
      h0LT_tt_cat_iso->Add(h0J_tt_cat_iso);
      h0LT_tt_cat_iso->Write();
    }
    else{
      h0LT_tt_cat_iso->SetName(name.c_str()+postfixLT);
      h0LT_tt_cat_iso->Write();
      h0J_tt_cat_iso->SetName(name.c_str()+postfixJ);
      h0J_tt_cat_iso->Write();
    }
    TDirectory *d0_tt_cat_anti =fout->mkdir("et_0jet_tt_cat_anti");
    d0_tt_cat_anti->cd();
    if (sample=="data_obs" or sample=="W"){
      h0LT_tt_cat_anti->SetName(name.c_str());
      h0LT_tt_cat_anti->Add(h0J_tt_cat_anti);
      h0LT_tt_cat_anti->Write();
    }
    else{
      h0LT_tt_cat_anti->SetName(name.c_str()+postfixLT);
      h0LT_tt_cat_anti->Write();
      h0J_tt_cat_anti->SetName(name.c_str()+postfixJ);
      h0J_tt_cat_anti->Write();
    }

    TDirectory *d0_tt_mjj_iso =fout->mkdir("et_0jet_tt_mjj_iso");
    d0_tt_mjj_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_tt_mjj_anti =fout->mkdir("et_0jet_tt_mjj_anti");
    d0_tt_mjj_anti->cd();
    if (sample=="data_obs" or sample=="W"){
