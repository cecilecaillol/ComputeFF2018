...
parser.add_argument('--directory', default="files_rawFF_mt", help="Which TES?")
...
dir_qcd=["mt_0jet_qcd_anti","mt_0jet_qcd_iso","mt_0SSloose_qcd_anti","mt_0SSloose_qcd_iso","mt_1jet_qcd_anti","mt_1jet_qcd_iso","mt_1SSloose_qcd_anti","mt_1SSloose_qcd_iso"]
ncat_qcd=8

if "corr1" in options.directory:
  ncat_qcd=4

if "OSSSF" in options.directory:    
  ncat_qcd=2
...
dir_w=["mt_0jet_w_anti","mt_0jet_w_iso","mt_1jet_w_anti","mt_1jet_w_iso"]
ncat_w=4
if "corr1" in options.directory:
  ncat_w=2
if "OSSSF" in options.directory:
...
dir_tt=["mt_0jet_tt_anti","mt_0jet_tt_iso"]
ncat_tt=2
if "OSSSF" in options.directory:
  ncat_tt=0
